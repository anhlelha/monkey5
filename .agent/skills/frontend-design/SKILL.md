...
| [mockup-guide.md](mockup-guide.md) | 🔴 **REQUIRED** | When creating ANY mockup/HTML UI |
...
> 🔴 **ux-psychology.md = ALWAYS READ. mockup-guide.md = READ when building HTML mockups. Others = only if relevant.**
...
- [mockup-guide.md](mockup-guide.md) - **Mockup creation standard**: HTML+CSS structure, design tokens, SVG icons, component patterns (based on `ref/mockups/`)
