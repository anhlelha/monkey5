...
const BAI: Bai[] = [
  ...
  // ─── 15. Ba nhóm giao nhau — nguyên lý bù trừ (log) ──────────────────────
  // Các số liệu "cả hai nhóm" đều bao gồm người thuộc cả ba nhóm. Bộ bài đi
  // từ tính hợp ba nhóm đến tìm phần bù, đúng một/đúng hai nhóm và dữ kiện ẩn.
  {
    key: "ba-nhom-bu-tru",
    title: "Suy luận logic — ba nhóm giao nhau",
    minutes: 25,
    questions: [
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Một lớp có 18 bạn thích Toán, 16 bạn thích Khoa học và 14 bạn thích Tiếng Anh. Có 5 bạn thích cả Toán và Khoa học, 4 bạn thích cả Toán và Tiếng Anh, 3 bạn thích cả Khoa học và Tiếng Anh; trong đó có 2 bạn thích cả ba môn. Hỏi có tất cả bao nhiêu bạn thích ít nhất một trong ba môn? (Số bạn thích cả hai môn đã bao gồm những bạn thích cả ba môn.)",
        correct: "38",
        num: 38,
        unit: "bạn",
        modelAnswer: "Áp dụng nguyên lý bù trừ: $18+16+14-5-4-3+2=38$. Vậy có $38$ bạn thích ít nhất một trong ba môn.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Thư viện thống kê có 25 bạn mượn truyện lịch sử, 22 bạn mượn truyện khoa học và 20 bạn mượn truyện văn học. Có 8 bạn mượn cả truyện lịch sử và khoa học, 7 bạn mượn cả truyện lịch sử và văn học, 6 bạn mượn cả truyện khoa học và văn học; trong đó có 3 bạn mượn cả ba loại. Hỏi có bao nhiêu bạn đã mượn ít nhất một loại truyện? (Số bạn mượn cả hai loại đã bao gồm những bạn mượn cả ba loại.)",
        correct: "49",
        num: 49,
        unit: "bạn",
        modelAnswer: "Áp dụng nguyên lý bù trừ: $25+22+20-8-7-6+3=49$. Vậy có $49$ bạn đã mượn ít nhất một loại truyện.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Trong một khối học sinh, có 24 bạn chơi bóng đá, 20 bạn chơi cầu lông và 18 bạn chơi cờ vua. Có 7 bạn chơi cả bóng đá và cầu lông, 6 bạn chơi cả bóng đá và cờ vua, 5 bạn chơi cả cầu lông và cờ vua; trong đó có 2 bạn chơi cả ba môn. Hỏi có tất cả bao nhiêu bạn chơi ít nhất một trong ba môn? (Số bạn chơi cả hai môn đã bao gồm những bạn chơi cả ba môn.)",
        correct: "46",
        num: 46,
        unit: "bạn",
        modelAnswer: "Áp dụng nguyên lý bù trừ: $24+20+18-7-6-5+2=46$. Vậy có $46$ bạn chơi ít nhất một trong ba môn.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Khối 5 có 120 học sinh. Trong đó, 52 bạn tham gia câu lạc bộ Toán, 48 bạn tham gia câu lạc bộ Tiếng Anh và 40 bạn tham gia câu lạc bộ Khoa học. Có 15 bạn tham gia cả Toán và Tiếng Anh, 12 bạn tham gia cả Toán và Khoa học, 10 bạn tham gia cả Tiếng Anh và Khoa học; trong đó có 5 bạn tham gia cả ba câu lạc bộ. Hỏi có bao nhiêu học sinh không tham gia câu lạc bộ nào trong ba câu lạc bộ trên? (Số bạn tham gia cả hai câu lạc bộ đã bao gồm những bạn tham gia cả ba câu lạc bộ.)",
        correct: "12",
        num: 12,
        unit: "học sinh",
        modelAnswer: "Số học sinh tham gia ít nhất một câu lạc bộ là $52+48+40-15-12-10+5=108$ (học sinh). Số học sinh không tham gia câu lạc bộ nào là $120-108=12$ (học sinh).",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Có 45 học sinh tham gia ít nhất một trong ba câu lạc bộ Cờ vua, Bóng bàn và Cầu lông. Biết có 21 bạn tham gia Cờ vua, 19 bạn tham gia Bóng bàn và 17 bạn tham gia Cầu lông. Có 6 bạn tham gia cả Cờ vua và Bóng bàn, 5 bạn tham gia cả Cờ vua và Cầu lông, 4 bạn tham gia cả Bóng bàn và Cầu lông. Hỏi có bao nhiêu bạn tham gia cả ba câu lạc bộ? (Số bạn tham gia cả hai câu lạc bộ đã bao gồm những bạn tham gia cả ba câu lạc bộ.)",
        correct: "3",
        num: 3,
        unit: "bạn",
        modelAnswer: "Gọi số bạn tham gia cả ba câu lạc bộ là $x$. Theo nguyên lý bù trừ: $21+19+17-6-5-4+x=45$, hay $42+x=45$. Suy ra $x=3$ bạn.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Một trường có 28 bạn tham gia câu lạc bộ Toán, 24 bạn tham gia câu lạc bộ Tiếng Anh và 20 bạn tham gia câu lạc bộ Cờ vua. Có 9 bạn tham gia cả Toán và Tiếng Anh, 7 bạn tham gia cả Toán và Cờ vua, 6 bạn tham gia cả Tiếng Anh và Cờ vua; trong đó có 3 bạn tham gia cả ba câu lạc bộ. Hỏi có bao nhiêu bạn chỉ tham gia đúng một câu lạc bộ? (Số bạn tham gia cả hai câu lạc bộ đã bao gồm những bạn tham gia cả ba câu lạc bộ.)",
        correct: "37",
        num: 37,
        unit: "bạn",
        modelAnswer: "Chỉ tham gia Toán: $28-9-7+3=15$ (bạn). Chỉ tham gia Tiếng Anh: $24-9-6+3=12$ (bạn). Chỉ tham gia Cờ vua: $20-7-6+3=10$ (bạn). Vậy số bạn chỉ tham gia đúng một câu lạc bộ là $15+12+10=37$ bạn.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Trong một cuộc thi, có 30 bạn đăng kí chạy, 26 bạn đăng kí bơi và 22 bạn đăng kí đạp xe. Có 10 bạn đăng kí cả chạy và bơi, 8 bạn đăng kí cả chạy và đạp xe, 7 bạn đăng kí cả bơi và đạp xe; trong đó có 4 bạn đăng kí cả ba môn. Hỏi có bao nhiêu bạn đăng kí đúng hai môn thi? (Số bạn đăng kí cả hai môn đã bao gồm những bạn đăng kí cả ba môn.)",
        correct: "13",
        num: 13,
        unit: "bạn",
        modelAnswer: "Số bạn đăng kí đúng hai môn là $(10-4)+(8-4)+(7-4)=6+4+3=13$ bạn.",
      },
      {
        type: "fill",
        topic: "log",
        grade: "NC",
        stem: "Có 50 học sinh đọc ít nhất một trong ba loại sách: sách khoa học, sách lịch sử và sách văn học. Có 26 bạn đọc sách khoa học, 24 bạn đọc sách lịch sử, 20 bạn đọc sách văn học, 8 bạn đọc cả sách khoa học và lịch sử, 7 bạn đọc cả sách khoa học và văn học, 3 bạn đọc cả ba loại sách. Hỏi có bao nhiêu bạn đọc cả sách lịch sử và sách văn học? (Số bạn đọc cả hai loại sách đã bao gồm những bạn đọc cả ba loại.)",
        correct: "8",
        num: 8,
        unit: "bạn",
        modelAnswer: "Gọi số bạn đọc cả sách lịch sử và sách văn học là $x$. Theo nguyên lý bù trừ: $26+24+20-8-7-x+3=50$, hay $58-x=50$. Suy ra $x=8$ bạn.",
      },
    ],
  },
];
