...
export const CG_ENRICHMENT_MAP: Record<string, ExamOverride> = {
  ...
  // ─── NKSP 2026 — ĐGNL vào lớp 6 Trường Năng khiếu Sư phạm (Khối 5) ───────
  // Nguồn: public/ref_exam/Toan/NKSP/MATHX ... _ĐỀ.pdf + _ĐÁP ÁN.pdf (2026–2027).
  // correct/unit/figure sống trong official_exams_metadata.json; ở đây chỉ có
  // stem / options(C5) / modelAnswer. Câu 1–3 dùng chung dữ kiện về thận.
  "NKSP-2026-27-C1": {
    stem: "Thận mỗi ngày lọc được khoảng $1500$ l máu. Ban đầu thận lọc ra khoảng $180$ l nước tiểu đầu, nhưng cơ thể hấp thụ lại và chỉ thải ra khoảng $1{,}5$ l nước tiểu. Thể tích máu trong cơ thể người là $5$ l. Hỏi trung bình mỗi giờ thận lọc được bao nhiêu lít máu?",
    modelAnswer: [
      "Một ngày có $24$ giờ. Trung bình mỗi giờ thận lọc được số lít máu là:",
      "$$1500 : 24 = 62{,}5 \\text{ (lít)}.$$",
      "",
      "**Đáp số**: $62{,}5$ lít.",
    ].join("\n"),
  },
  "NKSP-2026-27-C2": {
    stem: "Thận mỗi ngày lọc được khoảng $1500$ l máu, trung bình mỗi giờ lọc được $62{,}5$ l máu. Thể tích máu trong cơ thể người là $5$ l. Hỏi cần bao nhiêu thời gian (phút) để thận lọc được toàn bộ máu trong $1$ lần?",
    modelAnswer: [
      "Thời gian để thận lọc hết $5$ l máu là:",
      "$$5 : 62{,}5 = 0{,}08 \\text{ (giờ)}.$$",
      "",
      "Đổi ra phút: $0{,}08 \\times 60 = 4{,}8$ (phút).",
      "",
      "**Đáp số**: $4{,}8$ phút.",
    ].join("\n"),
  },
  "NKSP-2026-27-C3": {
    stem: "Thận mỗi ngày lọc ra khoảng $180$ l nước tiểu đầu, nhưng cơ thể hấp thụ lại phần lớn và chỉ thải ra khoảng $1{,}5$ l nước tiểu. Hỏi phần được cơ thể hấp thụ lại ở nước tiểu đầu chiếm bao nhiêu phần trăm (làm tròn đến hàng đơn vị)?",
    modelAnswer: [
      "Lượng nước tiểu đầu được cơ thể hấp thụ lại là: $180 - 1{,}5 = 178{,}5$ (l).",
      "",
      "Phần được hấp thụ lại chiếm số phần trăm là:",
      "$$178{,}5 : 180 \\times 100\\% \\approx 99\\%.$$",
      "",
      "**Đáp số**: $99\\%$.",
    ].join("\n"),
  },
  "NKSP-2026-27-C4": {
    stem: "Có sáu bạn An, Bình, Hạnh, Phúc, Việt và Nam chơi một trò chơi. Mỗi bạn đấu với mỗi bạn khác đúng một ván: thắng được $2$ điểm, hòa thì mỗi người được $1$ điểm, thua được $0$ điểm. Biết An được $7$ điểm, Bình và Phúc mỗi người $5$ điểm, Việt được $3$ điểm và Hạnh được $4$ điểm. Hỏi Nam được mấy điểm?",
    modelAnswer: [
      "Sáu bạn đấu vòng tròn, số ván đã đấu là: $5 + 4 + 3 + 2 + 1 = 15$ (ván).",
      "",
      "Mỗi ván (dù thắng – thua hay hòa – hòa) đều tạo ra tổng $2$ điểm. Vậy tổng điểm của cả $15$ ván là: $15 \\times 2 = 30$ (điểm).",
      "",
      "Số điểm của Nam là: $30 - (7 + 5 + 5 + 3 + 4) = 30 - 24 = 6$ (điểm).",
      "",
      "**Đáp số**: $6$ điểm.",
    ].join("\n"),
  },
  "NKSP-2026-27-C5": {
    stem: "Một con xúc xắc tiêu chuẩn luôn có tổng số chấm ở $2$ mặt đối diện bằng $7$. Quan sát các hình khai triển dưới đây, hãy tìm hình gấp lại được một con xúc xắc tiêu chuẩn.",
    options: [
      { id: "A", text: "Hình A" },
      { id: "B", text: "Hình B" },
      { id: "C", text: "Hình C" },
    ...
    modelAnswer: [
      "Con xúc xắc tiêu chuẩn có các cặp mặt đối diện với tổng bằng $7$, tức là $1$–$6$, $2$–$5$ và $3$–$4$.",
      "",
      "Kiểm tra từng hình khai triển, chỉ có **Hình D** gấp lại được con xúc xắc thỏa mãn cả ba cặp mặt đối diện đều có tổng bằng $7$.",
      "",
      "**Đáp số**: Hình D.",
    ].join("\n"),
  },
  "NKSP-2026-27-C6": {
    stem: "Chùa Một Cột (còn gọi là Liên Hoa Đài) là một biểu tượng kiến trúc độc đáo của Việt Nam. Người ta vẽ lại mặt bằng đài sen hình vuông trên bản thiết kế với tỉ lệ $1 : 50$. Trên bản thiết kế, cạnh của hình vuông đo được là $8$ cm. Hỏi độ dài thực tế cạnh của đài sen hình vuông đó là bao nhiêu mét?",
    modelAnswer: [
      "Độ dài thực tế cạnh của đài sen là:",
      "$$8 \\times 50 = 400 \\text{ (cm)}.$$",
      "",
      "Đổi: $400$ cm $= 4$ m.",
      "",
      "**Đáp số**: $4$ m.",
  ...
  "NKSP-2026-27-C7": {
    stem: "Một thùng cá tươi chứa $20$ kg cá, trong đó lượng nước chiếm $80\\%$ khối lượng cá. Sau khi đem phơi khô một thời gian, lượng nước trong cá chỉ còn $60\\%$. Hỏi khối lượng cá sau khi phơi khô là bao nhiêu ki-lô-gam?",
    modelAnswer: [
      "Phần cá khô (không phải nước) trong cá tươi chiếm: $100\\% - 80\\% = 20\\%$.",
      "",
      "Khối lượng phần cá khô là: $20 \\times 20 : 100 = 4$ (kg). Phần này không thay đổi khi phơi.",
      "",
      "Sau khi phơi, nước chiếm $60\\%$ nên phần cá khô chiếm: $100\\% - 60\\% = 40\\%$ khối lượng cá lúc này.",
      "",
      "Vậy khối lượng cá sau khi phơi là: $4 : 40 \\times 100 = 10$ (kg).",
      "",
      "**Đáp số**: $10$ kg.",
    ].join("\n"),
  },
  "NKSP-2026-27-C8": {
    stem: "Thực hiện phép tính sau: $11{,}11 + 12{,}12 + 13{,}13 + \\ldots + 19{,}19$.",
    modelAnswer: [
      "Tách mỗi số hạng thành phần nguyên và phần thập phân:",
      "$$11{,}11 + 12{,}12 + \\ldots + 19{,}19 = (11 + 12 + \\ldots + 19) + (0{,}11 + 0{,}12 + \\ldots + 0{,}19).$$",
      "",
      "Tổng $11 + 12 + \\ldots + 19$ có $9$ số hạng: $(11 + 19) \\times 9 : 2 = 135$.",
      "",
      "Phần thập phân: $0{,}11 + 0{,}12 + \\ldots + 0{,}19 = \\dfrac{135}{100} = 1{,}35$.",
      "",
      "Vậy tổng cần tìm là: $135 + 1{,}35 = 136{,}35$.",
      "",
      "**Đáp số**: $136{,}35$.",
    ].join("\n"),
  },
  "NKSP-2026-27-C9": {
    stem: "Cho dãy hình được vẽ theo quy luật như hình bên. Hỏi hình thứ $26$ có bao nhiêu con vật?",
    modelAnswer: [
      "Xét số mèo: hình ở vị trí lẻ có $2$ con mèo, hình ở vị trí chẵn có $3$ con mèo. Vì $26$ là số chẵn nên hình thứ $26$ có $3$ con mèo.",
      "",
      "Xét số voi: Hình $1$ có $1$ con voi, Hình $2$ có $2$ con voi, …, Hình thứ $26$ có $26$ con voi.",
      "",
      "Vậy hình thứ $26$ có tổng số con vật là: $3 + 26 = 29$ (con vật).",
      "",
      "**Đáp số**: $29$ con vật.",
    ].join("\n"),
  },
  "NKSP-2026-27-C10": {
    stem: "Trong một buổi hòa nhạc có hai chiếc trống điện tử: trống thứ nhất cứ $4$ giây lại vang lên một tiếng, trống thứ hai cứ $6$ giây lại vang lên một tiếng. Khi bắt đầu, cả hai trống cùng vang lên một lúc. Hỏi sau $2$ phút có bao nhiêu lần cả hai trống cùng vang lên đồng thời (không kể lần đầu tiên)?",
    modelAnswer: [
      "Khoảng thời gian ngắn nhất để hai tiếng trống lại cùng vang lên là bội chung nhỏ nhất của $4$ và $6$, tức là $12$ giây.",
      "",
      "Đổi: $2$ phút $= 120$ giây.",
      "",
      "Số lần cả hai trống cùng vang lên (không kể lần đầu) là: $120 : 12 = 10$ (lần).",
      "",
      "**Đáp số**: $10$ lần.",
    ].join("\n"),
  },
  "NKSP-2026-27-B1": {
    stem: "Bạn Minh làm bài kiểm tra năng lực của câu lạc bộ Toán trường Hems. Lúc đầu mỗi bạn có sẵn $40$ điểm và phải trả lời $20$ câu hỏi: mỗi câu đúng được cộng $5$ điểm, mỗi câu sai bị trừ $2$ điểm, câu không trả lời thì không tính điểm. Biết bạn Minh được $111$ điểm và không trả lời $3$ câu. Hỏi bạn Minh trả lời đúng bao nhiêu câu?",
    modelAnswer: [
      "Số câu Minh đã trả lời là: $20 - 3 = 17$ (câu).",
      "",
      "Số điểm có được nhờ trả lời (không kể $40$ điểm ban đầu) là: $111 - 40 = 71$ (điểm).",
      "",
      "Giả sử cả $17$ câu đều đúng thì được: $5 \\times 17 = 85$ (điểm).",
      "",
      "Số điểm dôi ra so với thực tế là: $85 - 71 = 14$ (điểm).",
      "",
      "Mỗi khi thay một câu đúng bằng một câu sai, tổng điểm giảm: $5 + 2 = 7$ (điểm).",
      "",
      "Số câu trả lời sai là: $14 : 7 = 2$ (câu). Số câu trả lời đúng là: $17 - 2 = 15$ (câu).",
      "",
      "**Đáp số**: $15$ câu.",
    ].join("\n"),
  },
  "NKSP-2026-27-B2": {
    stem: "Tìm $5$ số tự nhiên khác nhau, biết rằng tổng của từng cặp $2$ số trong $5$ số đó (viết theo thứ tự tăng dần) lần lượt là: $1;\\ 3;\\ 4;\\ 5;\\ 6;\\ 8;\\ 10;\\ 11;\\ 13;\\ 15$.",
    modelAnswer: [
      "Với $5$ số, mỗi số xuất hiện trong đúng $4$ cặp, nên tổng của cả $10$ tổng cặp bằng $4$ lần tổng của $5$ số.",
      "",
      "Tổng của $5$ số là: $(1 + 3 + 4 + 5 + 6 + 8 + 10 + 11 + 13 + 15) : 4 = 76 : 4 = 19$.",
      "",
      "Tổng nhỏ nhất ($1$) là tổng hai số bé nhất; tổng lớn nhất ($15$) là tổng hai số lớn nhất. Suy ra số ở giữa (số lớn thứ ba) là: $19 - 15 - 1 = 3$.",
      "",
      "Tổng lớn thứ hai ($13$) là tổng của số lớn thứ ba và số lớn nhất, nên số lớn nhất là: $13 - 3 = 10$. Số lớn thứ hai là: $15 - 10 = 5$.",
      "",
      "Tổng nhỏ thứ hai ($3$) là tổng của số bé nhất và số lớn thứ ba, nên số bé nhất là: $3 - 3 = 0$. Số bé thứ hai là: $1 - 0 = 1$.",
      "",
      "Vậy $5$ số cần tìm là: $0;\\ 1;\\ 3;\\ 5;\\ 10$.",
      "",
      "**Đáp số**: $0;\\ 1;\\ 3;\\ 5;\\ 10$.",
    ].join("\n"),
  },
  "NKSP-2026-27-B3": {
    stem: "Nam viết một dãy số bắt đầu bằng $1;\\ 1;\\ 2$, biết rằng kể từ số thứ tư, mỗi số bằng tổng của $3$ số liền trước. Hỏi khi Nam viết đến số thứ $2026$ thì Nam đã viết được bao nhiêu số chẵn?",
    modelAnswer: [
      "Xét tính chẵn – lẻ của dãy: số thứ $4$ là $1 + 1 + 2 = 4$ (chẵn), số thứ $5$ là $1 + 2 + 4 = 7$ (lẻ), số thứ $6$ là $2 + 4 + 7 = 13$ (lẻ), số thứ $7$ là $4 + 7 + 13 = 24$ (chẵn), …",
      "",
      "Quy luật chẵn – lẻ lặp lại theo chu kì $4$ số: lẻ; lẻ; chẵn; chẵn.",
      "",
      "Ta có $2026 : 4 = 506$ (dư $2$), tức là có $506$ nhóm đầy đủ (lẻ; lẻ; chẵn; chẵn) và dư $2$ số cuối là (lẻ; lẻ).",
      "",
      "Mỗi nhóm có đúng $2$ số chẵn nên số các số chẵn đã viết là: $2 \\times 506 = 1012$ (số).",
      "",
      "**Đáp số**: $1012$ số chẵn.",
    ].join("\n"),
  },
  "NKSP-2026-27-B4": {
    stem: "Cho $3$ hình tròn có cùng bán kính $4$ cm; $A$, $B$, $C$ lần lượt là tâm của ba hình tròn như hình vẽ bên. Tính diện tích phần tô đậm.",
    modelAnswer: [
      "Bằng cách di chuyển (cắt – ghép) các mảnh của phần tô đậm, ta đưa phần tô đậm về đúng một nửa hình tròn bán kính $4$ cm.",
      "",
      "Diện tích một hình tròn là: $4 \\times 4 \\times 3{,}14 = 50{,}24$ (cm$^2$).",
      "",
      "Diện tích phần tô đậm là: $50{,}24 : 2 = 25{,}12$ (cm$^2$).",
      "",
      "**Đáp số**: $25{,}12$ cm$^2$.",
    ].join("\n"),
  },
  "NKSP-2026-27-B5": {
    stem: "Một đoàn tàu chạy qua một cây cầu dài $450$ m hết $40$ giây. Cũng với vận tốc đó, đoàn tàu chạy qua một đường hầm dài $750$ m hết $1$ phút. Hỏi chiều dài của đoàn tàu là bao nhiêu mét?",
    modelAnswer: [
      "Đổi $1$ phút $= 60$ giây.",
      "",
      "Đường hầm dài hơn cây cầu là: $750 - 450 = 300$ (m). Để đi hết phần dài hơn đó, đoàn tàu cần thêm: $60 - 40 = 20$ (giây).",
      "",
      "Vận tốc của đoàn tàu là: $300 : 20 = 15$ (m/giây).",
      "",
      "Khi qua cầu, quãng đường đoàn tàu đi được bằng chiều dài cầu cộng chiều dài đoàn tàu: $15 \\times 40 = 600$ (m).",
      "",
      "Chiều dài đoàn tàu là: $600 - 450 = 150$ (m).",
      "",
      "**Đáp số**: $150$ m.",
    ].join("\n"),
  },
  "NKSP-2026-27-B6": {
    // Nguồn chỉ suy ra được A = 4 (đáp án dừng ở đây); tổng mỗi hàng = 12.
    stem: "Cho hình vẽ bên, hãy điền các số từ $1$ đến $7$ vào các chữ cái $A, B, C, D, E, F, G$ (mỗi chữ cái ứng với một số khác nhau) sao cho tổng của $3$ số trên mỗi hàng (mỗi đường thẳng) đều bằng nhau. Hãy tìm số ứng với chữ cái $A$.",
    modelAnswer: [
      "Tổng các số từ $1$ đến $7$ là: $1 + 2 + \\ldots + 7 = 28$.",
      "",
      "Quan sát hình có $5$ hàng, mỗi hàng gồm $3$ chữ cái:",
      "- $A, E, B$ (cạnh $AB$)",
      "- $A, F, C$ (cạnh $AC$)",
      "- $A, G, D$ (đoạn $AD$)",
      "- $E, G, F$ (đoạn $EF$)",
      "- $B, D, C$ (cạnh $BC$)",
      "",
      "Khi cộng tổng của cả $5$ hàng, chữ $A$ được tính $3$ lần (nằm trên $3$ hàng), các chữ còn lại được tính $2$ lần. Do đó tổng của $5$ hàng bằng:",
      "$$2 \\times 28 + A = 56 + A.$$",
      "",
      "Vì $5$ hàng có tổng bằng nhau nên $56 + A$ phải chia hết cho $5$. Với $A$ là số từ $1$ đến $7$, chỉ có $A = 4$ thỏa mãn (vì $56 + 4 = 60$ chia hết cho $5$).",
      "",
      "Khi đó tổng mỗi hàng bằng $60 : 5 = 12$.",
      "",
      "**Đáp số**: $A = 4$ (tổng mỗi hàng bằng $12$).",
    ].join("\n"),
  },
  // === END NKSP 2026 ===
