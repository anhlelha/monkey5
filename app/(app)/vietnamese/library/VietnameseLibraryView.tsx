...
// Mirrors the english LibraryView "Đề chính thức" tab so Vietnamese looks identical.
export function VietnameseLibraryView({ exams, schools, readiness, userDone }: Props) {
  ...
  return (
    <div className="main">
      <TopBar crumbs={[{ label: "Tiếng Việt", href: "/vietnamese" }, "Đề thi"]} />

      <div className="content">
        <div className="page-head">
          <div>
            <h2>Đề thi Tiếng Việt</h2>
            <p>
        ...
        {kind === "reference" && (
          <Card>
            <div className="empty">Chưa có đề tham khảo Tiếng Việt. Sẽ bổ sung sau.</div>
          </Card>
        )}
                      ...
                      <Link key={e.id} href={`/exam/${e.id}`} className="exam-row">
                        ...
                        <div>
                          <div className="row" style={{ gap: 8, alignItems: "center" }}>
                            <span className="title">{e.title ?? `Tiếng Việt ${s?.name ?? e.school} · ${e.year}`}</span>
